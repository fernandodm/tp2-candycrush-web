		...
		<stripes:form beanclass="action.EditarNivelActionBean" focus="">
			...
			<table>
				...
				<tr>
					<td>Tablero: Filas</td>
					<td><stripes:text
							name="nivel.tablero.alto" value = "${nivel.tablero.alto}" style="width: 50px" /></td>
					...
					<td><stripes:text
							name="nivel.tablero.ancho" value = "${nivel.tablero.ancho}"
				...
				<tr>
					...
					<td><stripes:text
							name="nivel.cantidadMovimientos" value = "${nivel.cantidadMovimientos}"
							style="width: 50px" /></td>
					<stripes:errors
						field="nivel.cantidadMovimientos" />
					<td>Cantidad de puntos</td>

					<td><stripes:text
							name="nivel.puntajeMinimo" value = "${nivel.puntajeMinimo}"
			...
			<div class="datagrid" style="margin-top: 30px">
				...
				<table>
					...
					<tbody>
						<c:set var="n" value="${0}" />
						<c:forEach items="${nivel.objetivos}"
							var="objetivo">
							<tr class="alt">
